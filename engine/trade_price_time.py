...
def _minute_frame(ak, symbol: str, trade_date: str):
    ...
    try:
        # This fallback only returns the latest trading day's minute data and accepts HH:MM:SS.
        # It is used immediately after the same-day 15:10 settlement, never for historical guessing.
...
def annotate_conditional_buy_fills(ak, fills: list[dict], targets: list[dict], trade_date: str) -> None:
    """Add price-time evidence only. Never changes whether/price/size of a simulated fill."""
